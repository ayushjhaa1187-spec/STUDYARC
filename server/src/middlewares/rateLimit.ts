...
// 5 requests per day
export const diagnosticLimiter = createLimiter(
  24 * 60 * 60 * 1000,
  5,
  'Daily diagnostic limit reached. Please try again tomorrow.'
);
...
export const communityLimiter = createLimiter(
  60 * 60 * 1000,
  30,
...
export const paymentLimiter = createLimiter(
  24 * 60 * 60 * 1000,
  10,
  'Payment attempts limit reached.'
);
