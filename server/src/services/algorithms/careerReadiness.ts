export interface ReadinessMetrics {
    avgAssessed: number;
    avgSelfReported: number;
    noAssessedSkills: boolean;
    verifiedProjectsCount: number;
    uniqueCompletedCoreTasks: number;
...
export function calculateReadinessScore(metrics: ReadinessMetrics): { total: number, breakdown: any } {
    const W_TECH = 0.30;
