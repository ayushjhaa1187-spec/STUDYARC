...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-bright-bg p-4 relative overflow-hidden">
      {/* Background Orbs */}
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-brand-cyan/10 rounded-full blur-[120px]" />
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-brand-indigo/10 rounded-full blur-[120px]" />
      
      <div className="w-full max-w-md z-10">
        <div className="text-center mb-10">
          <h1 className="text-4xl font-heading font-bold text-white mb-3">Welcome Back</h1>
        ...
        <p className="text-center mt-8 text-slate-400">
          ...
          <Link href="/signup" className="text-brand-cyan hover:text-brand-teal font-medium transition-colors">
            Sign up
          </Link>
        </p>
      </div>
