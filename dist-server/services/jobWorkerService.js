...
export class JobWorkerService {
     ...
     */
    static async processBatch(limit = 5) {
    ...
    static async executeJob(job) {
        ...
        switch (job.type) {
            case 'ai_generation':
                ...
                await DiagnosticService.processDiagnosticJob(payload.assessmentId, payload.userId, payload.targetRole, payload.weeklyHours, payload.skills, payload.experienceLevel);
                break;
